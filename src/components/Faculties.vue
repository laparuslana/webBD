...
export default {
  ...
  methods: {
    ...
    async deleteAllUsers() {
      ...
      this.clearOldMsgs();
      let res = await axios.get(
        "http://localhost/webprojecttutorial/src/api/faculties.php?action=deleteAll"
      );
      const restData = res.data;
      console.log(restData.faculties);
      if (res.status == 200) {
    ...
    async deleteUser() {
      ...
      let res = await axios.post(
        "http://localhost/webprojecttutorial/src/api/faculties.php?action=delete",
        formData
      );
      const restData = res.data;
      console.log(restData.faculties);
    ...
    async dbConnection() {
      let res = await axios.get(
        "http://localhost/webprojecttutorial/src/api/faculties.php"
      );
      const restData = res.data;
    ...
    async addNewUser() {
      ...
      if (!this.v$.newFaculty.$error) {
        ...
        let res = await axios.post(
          "http://localhost/webprojecttutorial/src/api/faculties.php?action=create",
          formData
        );
        const restData = res.data;
        if (res.status == 200) {
    ...
    async updateUser() {
      ...
      if (!this.v$.currentFaculty.$error) {
        ...
        let formData = this.toFormData(this.currentFaculty);
        let res = await axios.post(
          "http://localhost/webprojecttutorial/src/api/faculties.php?action=update",
          formData
        );
        const restData = res.data;
        console.log(restData.faculties);
