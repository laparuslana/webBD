  ...
  <div class="container" v-else>
    ...
    <div id="overlay" v-if="showDeleteModal">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-danger">Delet Current Department</h5>
...
export default {
  ...
  methods: {
    ...
    async getFacultiesData() {
      let res = await axios.get(
        "http://localhost/webprojecttutorial/src/api/faculties.php?action=read"
      );
      const restData = res.data;
    ...
    async deleteAllUsers() {
      ...
      this.clearOldMsgs();
      let res = await axios.get(
        "http://localhost/webprojecttutorial/src/api/departments.php?action=deleteAll"
      );
      const restData = res.data;
      console.log(restData.departaments);
      if (res.status == 200) {
    ...
    async deleteUser() {
      ...
      let res = await axios.post(
        "http://localhost/webprojecttutorial/src/api/departments.php?action=delete",
        formData
      );
      const restData = res.data;
      console.log(restData.departaments);
    ...
    async dbConnection() {
      let res = await axios.get(
        "http://localhost/webprojecttutorial/src/api/departments.php"
      );
      const restData = res.data;
    ...
    async addNewUser() {
      ...
      if (!this.v$.newDepartment.$error) {
        ...
        let res = await axios.post(
          "http://localhost/webprojecttutorial/src/api/departments.php?action=create",
          formData
        );
        const restData = res.data;
        if (res.status == 200) {
    ...
    async updateUser() {
      ...
      if (!this.v$.currentDepartment.$error) {
        ...
        let formData = this.toFormData(this.currentDepartment);
        let res = await axios.post(
          "http://localhost/webprojecttutorial/src/api/departments.php?action=update",
          formData
        );
        const restData = res.data;
        console.log(restData.departaments);
